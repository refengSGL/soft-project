<template>
  <div class="home" style="padding: 10px">
    ...
    <div style="margin: 10px 0">
      <el-form inline="true" size="small">
        ...
        <el-form-item label="用户编号">
          <el-input v-model="search3" placeholder="请输入用户编号" clearable>
            <template #prefix
              ><el-icon class="el-input__icon"><search /></el-icon
            ></template>
          </el-input>
    ...
    >
      ...
      <el-table-column prop="returnTime" label="成交时间" sortable />
      <el-table-column prop="status" label="状态">
        <template v-slot="scope">
          <el-tag v-if="scope.row.status == 0" type="warning">未售出</el-tag>
    ...
    <div style="margin: 10px 0">
      ...
      <el-dialog v-model="dialogVisible" title="修改成交记录" width="30%">
        <el-form :model="form" label-width="120px">
          ...
          <el-form-item label="是否售出" prop="status">
            <el-radio v-model="form.status" label="0">未售出</el-radio>
            <el-radio v-model="form.status" label="1">已售出</el-radio>
          </el-form-item>
        </el-form>
        <template #footer>
          <span class="dialog-footer">
            <el-button @click="dialogVisible = false">取 消</el-button>
            <el-button type="primary" @click="save(form.number)"
              >确 定</el-button
            >
          </span>
        </template>
